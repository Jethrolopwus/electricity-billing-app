...
<div className="bg-gray-800 text-white h-screen w-1/5 p-4">
      ...
      <ul>
        <li className="mb-2 border-2 rounded-xl bg-slate-900 text-white " > <Link> Dashboard </Link> </li>
        <li className="mb-2 border-2 rounded-xl bg-slate-900 text-white "> <Link>Profile </Link></li>
